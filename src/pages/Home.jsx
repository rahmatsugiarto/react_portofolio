        ...
        <div className="bg-background-light dark:bg-background-dark min-h-screen">
            ...
            <div ref={heroRef} className="relative">
                <ScrollSequence 
                    ...
                    padZeros={4}
                >
                    <section className="hero-container h-screen flex flex-col justify-center px-6 md:px-12 relative overflow-hidden z-20">
