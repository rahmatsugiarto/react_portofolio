...
export const projects = [
    {
        title: 'DigiSign, DigiStamp (Telkomsign)',
        ...
        year: '2025',
        image: '/projects/telkomsign.webp',
        github: { url: '', isPrivate: true },
        playstore: '',
        appstore: ''
    },
    {
        title: 'DigiSign, DigiStamp, E-Materai, DMS App (Dexter)',
        ...
        year: '2023',
        image: '/projects/dexter.webp',
        github: { url: '', isPrivate: true },
        playstore: '',
        appstore: ''
    },
    {
        title: 'Event Management System (RAPIM TELKOMGROUP)',
    ...
    {
        title: 'Booking Room Meeting (Troo)',
        description: 'Developed "Troo", a streamlined room booking mobile application featuring multi-language support (Localization) and real-time push notifications via Firebase. Built with Flutter using Clean Architecture to ensure scalability and ease of maintenance.',
        tech: ['Flutter', 'Firebase', 'iOS', 'Android', 'Clean Architecture', 'Bloc', 'Localization'],
        year: '2023',
        image: '/projects/troo.webp',
        github: { url: '', isPrivate: true },
        playstore: '',
        appstore: ''
    },
    {
        title: 'Tenant Management Solution (Temanin)',
    ...
    //     tech: ['Flutter', 'iOS', 'Android', 'Clean Architecture', 'Bloc'],
    //     year: '2023',
    //     image: '/projects/under_construction.webp',
    //     github: { url: '', isPrivate: true },
    //     playstore: '',
    //     appstore: ''
    // },
    ...
    // },
    {
        ...
        tech: ['Flutter', 'RESTful API', 'Clean Architecture', 'Bloc', 'Firebase', 'Code Magic', 'Melos'],
        year: '2023',
        image: '/projects/ditonton.webp',
        github: { url: 'https://github.com/rahmatsugiarto/ditonton', isPrivate: false },
        playstore: '',
        appstore: ''
    },
    {
        title: 'Story App',
        description: 'Simple application Social Media using the Flutter framework. This project is one of the tasks to get a certificate in Learn Flutter Intermediate App Development (Dicoding).',
        tech: ['Flutter', 'RESTful API', 'Bloc'],
        year: '2023',
        image: '/projects/story_app.webp',
        github: { url: 'https://github.com/rahmatsugiarto/story_app', isPrivate: false },
        playstore: '',
        appstore: ''
    },
    {
        title: 'Restaurant App',
        description: 'Application that displays Restaurant information using the Flutter framework. This project is one of the tasks to get a certificate in Learn Flutter Application Fundamentals (Dicoding).',
        tech: ['Flutter'],
        year: '2023',
        image: '/projects/restaurant_app.webp',
        github: { url: 'https://github.com/rahmatsugiarto/restaurant_app', isPrivate: false },
        playstore: '',
        appstore: ''
    },
    {
        title: 'TV Series App',
        description: 'Application that displays TV series information using the Flutter framework. This project is one of the tasks to get a certificate in Learning to Make Flutter Applications for Beginners (Dicoding).',
        tech: ['Flutter'],
        year: '2023',
        image: '/projects/tv_series_app.webp',
        github: { url: 'https://github.com/rahmatsugiarto/tv_series_app', isPrivate: false },
        playstore: '',
        appstore: ''
    },
    {
        title: 'Foody - Food Recipes App ',
        description: 'Foody is a recipe application that displays various types of food recipes.',
        tech: ['Android', 'Kotlin', 'MVVM', 'Dependency Injection - Dagger-Hilt', 'RESTful API', 'Coroutine', 'Flow'],
        year: '2022',
        image: '/projects/foody.webp',
        github: { url: 'https://github.com/rahmatsugiarto/Recipes-app', isPrivate: false },
        playstore: '',
        appstore: ''
    },
    {
        title: 'Rock Paper Scissors Game (Sciroper)',
